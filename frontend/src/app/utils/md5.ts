// ponytail: raw MD5 — stdlib WebCrypto doesn't expose MD5 (only SHA-*).
// Gravatar needs MD5; this is the cheapest implementation that works.
...
export function gravatarUrl(email: string): string {
  return `https://www.gravatar.com/avatar/${md5(email.trim().toLowerCase())}?s=64&d=mp`;
}
